    ...
    function _handleSwap(
        ...
        if (zeroForOne) {
            ...
            if (state.currentLiquidity > 0) {
                ...
                IPosition.Info storage position = positions.get(state.sender, MIN_TICK, MAX_TICK);
                if (position.liquidity > 0) {
            ...
            if (state.currentLiquidity > 0) {
                ...
                IPosition.Info storage currentPosition = positions.get(state.sender, MIN_TICK, MAX_TICK);
